...
public class Function {
    ...
    public void viewAllUser() {
        ...
        System.out.format("+----+--------------------+--------------------+%n");
        System.out.format("+ STT+      username      +     Phòng ban      +%n");
        System.out.format("+----+--------------------+--------------------+%n");
        for (User user : userList) {
            System.out.format("+ %-2s +  %-16s  +  %-16s  +%n",
                    user.getId(), user.getUserName(), user.getDepartmentName());
            System.out.format("+----+--------------------+--------------------+%n");
//            System.out.println(user);
    ...
    public void findUserById() {
        ...
        ResponseBase<User> responseBase = userController.findUserByIdV2(id);
